		...
		tooltip: function(settings) {
			...
			return this.each(function() {
					...
					if(this.title!=null && this.title.length>0 ){
						...
						//设置按钮提示内容
						//if(jQuery(this).text()!=null && jQuery(this).text().length>0 && (this.type=='button' || this.type=='submit')){
						//	this.tooltipText=jQuery(this).text();
						//}
						//设置文本框提示内容
						//if(this.type!=null && this.type.length>0 && this.type=='text'){
						//		this.tooltipText="请输入"+jQuery.trim(jQuery(this).parent().prev().text().substring(0, jQuery(this).parent().prev().text().length - 1));
						//}
						//设置选择框提示内容
						//if(this.type!=null && this.type.length>0 && this.type=='select-one'){
						//	this.tooltipText="请选择"+jQuery.trim(jQuery(this).parent().prev().text().substring(0, jQuery(this).parent().prev().text().length - 1));
						//}
						//this.tooltipText=this.val();
					}
					//jQuery(this).removeAttr("title");
